...
with open(r"C:\Users\harish\Downloads\stop.txt","r") as sw:
    stop = sw.read()
stop
...
with open(r"C:\Users\harish\Downloads\positive-words.txt","r") as pos:
    poswords= pos.read().split("\n")
poswords = poswords[36:]

# Importing the negative words
with open(r"C:\Users\harish\Downloads\negative-words.txt","r") as neg:
